  ...
  const BRANCH_DATA = {
    ...
    "ICOOL TRẦN NÃO": {
      Trệt: ["P.100", "P.101", "P.102", "P.103", "P.104", "P.105", "P.106", "P.107", "P.108", "P.109"],
      "Tầng 1": ["P.200", "P.201", "P.202", "P.203", "P.204", "P.205", "P.206", "P.208"],
      "Tầng 2": ["P.300", "P.301", "P.302", "P.303", "P.304", "P.305", "P.306", "P.307", "P.308"],
      "Tầng 3": ["P.400", "P.401", "P.402", "P.403"],
    },
    "ICOOL THÀNH THÁI": {
      Trệt: ["P.001"],
